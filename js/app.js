    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                observeParents: true,
                navigation: {
                    nextEl: ".main-block__slider .control-main-block__arrow_next",
                    prevEl: ".main-block__slider .control-main-block__arrow_prev"
                },
                loop: true,
                parallax: true,
                speed: 1e3,
            ...
            if (document.querySelector(".sales-leaders__slider")) new core(".sales-leaders__slider", {
                modules: [ Navigation ],
                slidesPerView: 4,
                spaceBetween: 0,
                observeParents: true,
                navigation: {
                    nextEl: ".sales-leaders__slider .arrows-slider__arrow_next",
                    prevEl: ".sales-leaders__slider .arrows-slider__arrow_prev"
                },
                loop: true,
                speed: 800,
                breakpoints: {
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                const targetElement = e.target;
                if (innerWidth > 767) if (targetElement.classList.contains("search-form__icon")) document.querySelector(".search-form").classList.toggle("_active"); else if (!targetElement.closest(".search-form") && document.querySelector(".search-form._active")) document.querySelector(".search-form").classList.remove("_active");
                if (innerWidth < 767) {
                    const filterCatalog = document.querySelector(".filter-catalog");
                    if (targetElement.classList.contains("sort-catalog__button-filters")) {
                        filterCatalog.classList.add("_active");
                        filterCatalog.classList.add("shadow");
                        document.body.classList.add("p-none");
                        bodyLockToggle();
                    } else if (targetElement.classList.contains("filter-catalog__close") || document.querySelector(".filter-catalog._active") && !targetElement.closest(".filter-catalog")) {
                        if (!targetElement.closest(".filter-catalog")) e.preventDefault();
                        filterCatalog.classList.remove("_active");
                        filterCatalog.classList.remove("shadow");
                        document.body.classList.remove("p-none");
                        bodyLockToggle();
                    }
                }
                if (targetElement.closest(".data-registration__title")) {
                    const registrationTitles = document.querySelectorAll(".data-registration__title");
                    for (let i = 0; i < registrationTitles.length; i++) {
                        const registrationTitle = registrationTitles[i];
                        if (!registrationTitle.closest("._tab-active")) registrationTitle.querySelector(".checkbox__input").removeAttribute("checked");
                        if (registrationTitle.closest("._tab-active")) registrationTitle.querySelector(".checkbox__input").setAttribute("checked", "");
                    }
                }
                if (targetElement.classList.contains("added-products__button")) document.querySelector(".added-products__list").classList.toggle("_active"); else if (!targetElement.closest(".added-products__list") && document.querySelector(".added-products__list._active")) document.querySelector(".added-products__list").classList.remove("_active");
                if (targetElement.classList.contains("icon-attention")) document.querySelector(".icon-attention").classList.toggle("_active"); else if (!targetElement.closest(".tip-phone") && document.querySelector(".icon-attention._active")) document.querySelector(".tip-phone").classList.remove("_active");
                if (targetElement.classList.contains("icon-cart")) {
                    document.querySelector(".cart-actions").classList.toggle("_active");
                    console.log("kkk");
                } else if (!targetElement.closest(".cart-actions") && document.querySelector(".cart-actions._active")) document.querySelector(".cart-actions").classList.remove("_active");
                if (targetElement.classList.contains("icon-user")) document.querySelector(".menu-user").classList.toggle("_active"); else if (!targetElement.closest(".menu-user") && document.querySelector(".menu-user._active") || targetElement.classList.contains("menu-user__colse")) {
                    console.log("say ok");
                    document.querySelector(".menu-user").classList.remove("_active");
                }
            }
        };
        window["FLS"] = true;
